...
urlpatterns = [
    ...
    url(r'^api/expenses/', views.ExpensesList.as_view()), # single expense overview
    url(r'^api/expenses/approvals', views.ExpensesList.as_view()), # single expense approvals
    url(r'^api/expenses/payments', views.ExpensesList.as_view()), # single expense payments
